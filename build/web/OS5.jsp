...
<html>
    ...
    <body>
        ...
        <div class="container-main">
            ...
            <p class="content">
            <h3 class="inner">
                <br><br><b>File System in Operating System</b><br>
...
●When operating system defines different file structures, it also contains the code to support these file structure. Unix, MS-DOS support minimum number of file structure.<br>
  ...
  <br><br><b>Security in Operating System</b><br>
  Security :
...
If a computer program is run by an unauthorized user, then he/she may cause severe damage to computer or data stored in it. So a computer system must be protected against unauthorized access, malicious access to system memory, viruses, worms etc. We're going to discuss following topics in this chapter<br>
●Authentication<br>
●One Time passwords<br>
●Program Threats<br>
●System Threats<br>
●Computer Security Classifications<br><br>
