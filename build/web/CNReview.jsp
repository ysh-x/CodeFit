...
<!DOCTYPE html>
<%
    ResultsBean CN = (ResultsBean)request.getAttribute("RB");
    int[] ans = CN.getCNResult();
    boolean[] verd = CN.getCNAnswers();
 %>
...
<html>
    ...
    <body>
        ...
        <h2 class = "result-board" >Score   | <%=CN.getCNScores() %> / 20 </h2><br>
        <h2 class = "result-board">Verdict <br><%=CN.getCNVerdict() %> </h2>
