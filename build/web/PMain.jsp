        ...
        <div class="container-main">
            ...
            <h3>
                <ol type="1" class ="list">
                    <li><a href="./P1.jsp">Chapter 1 | Basics Of Python Programming </a></li>
                    <li><a href="./P2.jsp">Chapter 2 | Functioning Of Python Programming </a></li>
                    <li><a href="./P3.jsp">Chapter 3 | Lists , Tuples And Dictionary in Python</a></li>
