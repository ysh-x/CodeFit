        ...
        <div class="container-main">
            ...
            <h3>
                <ol type="1" class ="list">
                    <li><a href="./C1.jsp">Chapter 1 | Basics Of C Programming </a></li>
                    <li><a href="./C2.jsp">Chapter 2 | Basic Syntax </a></li>
                    <li><a href="./C3.jsp">Chapter 3 | Operators and Functions in C Language</a></li>
