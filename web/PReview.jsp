...
<!DOCTYPE html>
<%
    ResultsBean P = (ResultsBean)request.getAttribute("RB");
    int[] ans = P.getPResult();
    boolean[] verd = P.getPAnswers();
 %>
...
<html>
    ...
    <body>
        ...
        <h2 class = "result-board" >Score   | <%=P.getPScores() %> / 20 </h2><br>
        <h2 class = "result-board">Verdict <br><%=P.getPVerdict() %> </h2>
