    ...
    <body>
        ...
        <div class="LoginFormReg">
            ...
            <form action = "Register" onsubmit="return checkReg()"  method="post">
                ...
                <br>
                <input class = "text" type="text" placeholder="<%=ques[0]%>"  id = "Q1" name = "Q1" required><br><br>
                <input class = "text" type="text" placeholder="<%=ques[1]%>"  id = "Q2" name = "Q2" required><br><br>
                <input class = "text" type="text" placeholder="<%=ques[2]%>"  id = "Q3" name = "Q3" required><br><br>
                <input class = "text" style="visibility: hidden" type="text" placeholder="<%=ques[3]%>"  id = "Code" name = "Code" value="<%=ques[3]%>"><br><br>
