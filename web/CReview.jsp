...
<!DOCTYPE html>
<%
    ResultsBean C = (ResultsBean)request.getAttribute("RB");
    int[] ans = C.getCResult();
    boolean[] verd = C.getCAnswers();
 %>
...
<html>
    ...
    <body>
        ...
        <h2 class = "result-board" >Score   | <%=C.getCScores() %> / 20 </h2><br>
        <h2 class = "result-board">Verdict <br><%=C.getCVerdict() %> </h2>
